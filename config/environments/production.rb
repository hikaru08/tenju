Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "tenju_#{Rails.env}"
  ...
  config.action_mailer.default_url_options = {  :host => 'https://tenju.net' }
  ...
  config.action_mailer.smtp_settings = {
    ...
    user: Rails.application.credentials.gmail[:user],
    #gmail２段階認証回避のためにアプリケーションでの利用パスワードを取得、必ずcredentials.yml.endに設定を！！
    pass: Rails.application.credentials.gmail[:pass],
    #パスワードをBase64でエンコード
